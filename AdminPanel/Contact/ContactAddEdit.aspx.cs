...
public partial class AdminPanel_Contact_ContactAddEdit : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            {
                lblMessage.Text = "<b>--- Edit Mode | ContactID = </b>" + Page.RouteData.Values["ContactID"];
                FillContactControls(Convert.ToInt32(Page.RouteData.Values["ContactID"]));
            }
            else
            {
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Page.RouteData.Values["ContactID"] != null)
            {
                ...
                //edit Mode
                ContactID = Convert.ToInt32(Page.RouteData.Values["ContactID"].ToString().Trim());
    ...
    {
        CommonDropDownFillMethod.FillDropDownListCity(ddlStateID, ddlCountryID, ddlCityID, lblMessage);
    }
    #endregion FillCity
        ...
        try
        {
            ...
            if (objSDR.HasRows)
            {
                while (objSDR.Read())
                {
                    ...
                    if (objSDR["LinkedlNid"].Equals(DBNull.Value) != true)
                    {
                        txtLinkedlnID.Text = objSDR["LinkedlNid"].ToString().Trim();
                    }
